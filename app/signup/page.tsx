    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Join Nigeria's leading legal platform</p>
        </div>

        <Card className="shadow-sm border-gray-200">
          <CardHeader className="space-y-1">
            <CardTitle className="text-xl text-center">Get started</CardTitle>
            <CardDescription className="text-center">Create your account to access legal tools</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">
                ...
                <Link href="/signin" className="text-slate-600 hover:text-slate-800 font-medium">
                  Sign in
                </Link>
              </span>
            </div>
